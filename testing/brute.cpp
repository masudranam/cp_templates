...
//   auto [dn, up] = convexHull(ps);
//   reverse(all(up));
//   int q; cin >> q;
//   while (q--) {
//     int x, y; cin >> x >> y;
//     P p {x, y};
//     if (x < mix || x > mxx) { cout << "OUT"; NL; continue; }
//     P l, r;
//     auto it = lower_bound(all(dn), p);
//     if (it == dn.end()) {
//       cout << "OUT"; NL; continue;
//     } else if (it == dn.begin()) {
//       cout << (*it == p ? "ON" : "OUT"); NL; continue;
//     } else {
//       l = *prev(it), r = *it;
//       int dir = sgn(det(r - l, p - l));
//       if (dir == -1) { cout << "OUT"; NL; continue; }
//       if (dir == 0) { cout << "ON"; NL; continue; }
//     }
//     it = upper_bound(all(up), p);
//     if (it == up.end()) {
//       cout << "OUT"; NL; continue;
//     } else if (it == up.begin()) {
//       cout << (*it == p ? "ON" : "OUT"); NL; continue;
